...
execute if score *Jumpscare Timer matches 1..25 as @a run function fnaf:jumpscares/shake
...
execute if score *Jumpscare Timer matches 351 run function fnaf:menu_start
execute if score *Jumpscare Timer matches 351 run scoreboard players set *JumpscareType Game 0
execute if score *Jumpscare Timer matches 351 run scoreboard players reset *Jumpscare Timer
