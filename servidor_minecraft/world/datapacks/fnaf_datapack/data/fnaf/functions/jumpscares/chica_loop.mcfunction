...
execute if score *Jumpscare Timer matches 26 as @e[tag=chica] run function chica:animations/jumpscare/stop
execute if score *Jumpscare Timer matches 27 as @e[tag=chica] run function chica:set_variant/invisible
