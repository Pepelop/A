...
execute as @e[type=minecraft:area_effect_cloud,tag=aj.chica.bone,distance=..5.529] if score @s aj.id = .this aj.id run function chica:zzz/execute/58
execute as @e[type=minecraft:armor_stand,tag=aj.chica.bone,distance=..5.529] if score @s aj.id = .this aj.id run function chica:zzz/execute/59
